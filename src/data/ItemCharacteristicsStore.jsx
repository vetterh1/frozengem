...
const defaultCharacteristics = {
    version: 25,    
    categories: [
      {name: {en: 'Bread', fr: 'Pain'}, label: {en: '', fr: ''}, id2: 'B', icon: 'bread-slice', expiration: '1', expirationMinusPlus:{} },
      {name: {en: 'Vegetables', fr: 'Légumes'}, label: {en: '', fr: ''}, id2: 'V', icon: 'carrot', expiration: '12', expirationMinusPlus:{DRAW: '-6'}},
      {name: {en: 'Fruits', fr: 'Fruits'}, label: {en: '', fr: ''}, id2: 'F', icon: 'apple-alt', expiration: '12', expirationMinusPlus:{DRAW: '-6'}},
      {name: {en: 'Soup', fr: 'Soupe'}, label: {en: '', fr: ''}, id2: 'S', icon: 'glass-whiskey', expiration: '3', expirationMinusPlus:{}},
      {name: {en: 'Dish', fr: 'Plat'}, label: {en: '', fr: ''}, id2: 'P', icon: 'utensils', expiration: '3', expirationMinusPlus:{}},
      {name: {en: 'Meat', fr: 'Viande'}, label: {en: '', fr: ''}, id2: 'M', icon: 'drumstick-bite', expiration: '1', expirationMinusPlus:{DCOO: '+3', DPOU: '+2', DPOR: '+2', DBEE: '+4'}},
      {name: {en: 'Fish', fr: 'Poisson'}, label: {en: '', fr: ''}, id2: 'H', icon: 'fish', expiration: '2', expirationMinusPlus:{}},
      {name: {en: 'Desert', fr: 'Dessert'}, label: {en: '', fr: ''}, id2: 'D', icon: 'birthday-cake', expiration: '2', expirationMinusPlus:{}},
      {name: {en: 'Ice cream', fr: 'Glace'}, label: {en: '', fr: ''}, id2: 'I', icon: 'ice-cream', expiration: '4', expirationMinusPlus:{}},
    ],
    details:[
      {name: {en: 'Homemade', fr: 'Fait maison'}, label: {en: '', fr: ''}, id2: 'DHOM', icon: 'home', parents:['all'] },
      {name: {en: 'Cooked', fr: 'Cuit'}, label: {en: '', fr: ''}, id2: 'DCOO', icon: 'burn', parents:['V', 'S', 'M', 'P', 'H', 'F'] },
      {name: {en: 'Raw', fr: 'Cru'}, label: {en: '', fr: ''}, id2: 'DRAW', icon: 'snowflake', parents:['V', 'S', 'M', 'P', 'H', 'F'] },
      {name: {en: 'White', fr: 'Blanc'}, label: {en: '', fr: ''}, id2: 'DWHI', icon: '', parents:['B'] },
      {name: {en: 'Grey', fr: 'Gris'}, label: {en: '', fr: ''}, id2: 'DGRE', icon: '', parents:['B']},
      {name: {en: 'Cereal', fr: 'Céréales'}, label: {en: '', fr: ''}, id2: 'DCER', icon: '', parents:['B']},
      {name: {en: 'Cake', fr: 'Gateau'}, label: {en: '', fr: ''}, id2: 'DCAK', icon: 'bread-slice', parents:['D']},
      {name: {en: 'Pie', fr: 'Tarte'}, label: {en: '', fr: ''}, id2: 'DPIE', icon: 'birthday-cake', parents:['D']},
      {name: {en: 'Vanilla', fr: 'Vanille'}, label: {en: '', fr: ''}, id2: 'DVAN', icon: '', parents:['D', 'I']},
      {name: {en: 'Strawberry', fr: 'Fraise'}, label: {en: '', fr: ''}, id2: 'DSTR', icon: '', parents:['D', 'I']},
      {name: {en: 'Chocolate', fr: 'Chocolat'}, label: {en: '', fr: ''}, id2: 'DCHO', icon: '', parents:['D', 'I']},
      {name: {en: 'Poultry', fr: 'Volaille'}, label: {en: '', fr: ''}, id2: 'DPOU', icon: '', parents:['S', 'M', 'P']},
      {name: {en: 'Beef', fr: 'Beuf'}, label: {en: '', fr: ''}, id2: 'DBEE', icon: '', parents:['S', 'M', 'P']},
      {name: {en: 'Pork', fr: 'Porc'}, label: {en: '', fr: ''}, id2: 'DPOR', icon: '', parents:['S', 'M', 'P']},
      {name: {en: 'Veal', fr: 'Veau'}, label: {en: '', fr: ''}, id2: 'DVEA', icon: '', parents:['M', 'P']},
      {name: {en: 'Fish', fr: 'Poisson'}, label: {en: '', fr: ''}, id2: 'DFIS', icon: 'fish', parents:['S', 'P']},
      {name: {en: 'Vegetarian', fr: 'Végétarien'}, label: {en: '', fr: ''}, id2: 'DVEG', icon: 'carrot', parents:['S', 'P']},
    ],
    containers:[
